namespace ExecutorsSelection
{
	public class ProjectFactory
	{
		...
		public double NoDeadlineProbability { get; set; } = 0.4;
		public double AverageHoursToDeadline { get; set; } = 8 * 3;
		public double AveragePages { get; set; } = 50;

		public double AverageMaxCostPerPage { get; set; } = 5;
		public double UnlimitedCostProbability { get; set; } = 0.1;
		...
		/// </summary>
		public double AverageDeltaCost { get; set; } = 0.5;
		...
		public double QualityNotImportantProbability { get; set; } = 0.2;
